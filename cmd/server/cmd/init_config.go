...
func initConfig(cmd *cobra.Command) error {
	...
	_ = viper.BindPFlag("allow_ports", cmd.Flags().Lookup("allow-ports"))
	...
	logrus.Debugf("config init completed: %+v", string(xutil.RemoveError(json.Marshal(config.ServerConf))))
	return nil
}
